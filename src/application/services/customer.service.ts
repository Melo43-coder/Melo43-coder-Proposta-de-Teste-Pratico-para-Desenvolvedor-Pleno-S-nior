...
import { ProducerService } from '../../infrastructure/messaging/kafka/producer';
...
export class CustomerService {
  ...
  async getCustomerById(id: string): Promise<Customer | null> {
    try {
      ...
      const cachedCustomer = await this.cacheService.get<Customer>(cacheKey);
  ...
  async getAllCustomers(): Promise<Customer[]> {
    try {
      ...
      const cachedCustomers = await this.cacheService.get<Customer[]>(cacheKey);
